...
<head>
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{ secure_asset('admin/') }}/plugins/jqvmap/jqvmap.min.css">
  <!-- Theme style -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{ secure_asset('admin/') }}/plugins/summernote/summernote-bs4.min.css">
...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto mx-5">
      ...
      @endguest
            ...
            <div class="user-panel d-flex">
                <div class="image">
                  <img src="{{ secure_asset('admin/') }}/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
                </div>
              </div>
        </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="{{ secure_asset('admin/') }}/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
...
<script src="{{ secure_asset('admin/') }}/dist/js/pages/dashboard.js"></script>
