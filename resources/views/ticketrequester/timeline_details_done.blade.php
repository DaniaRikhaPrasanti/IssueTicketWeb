...
<div class="card mt-3">
    <div class="row">
        <div class="container mb-5 col-10 col-md-8">
            ...
            <span style ="background-color: blue; border-radius: 4px; padding: 7px; color: white; 
            font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 15px; margin-left: 20px; center;"> Done </span>
            </div>
            <hr>
            <div class="form">
                <form action="POST">
                    <label for="Ag_Name" class="form-label">Team : </label>
                    ...
                    <label for="Tick_Issue" class="form-label">Response : </label>
